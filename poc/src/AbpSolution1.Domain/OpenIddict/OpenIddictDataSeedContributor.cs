    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        if (!postmanClientId.IsNullOrWhiteSpace())
        {
            await CreateApplicationAsync(
                ...
                type: OpenIddictConstants.ClientTypes.Public,
                consentType: OpenIddictConstants.ConsentTypes.Implicit,
                displayName: "Postman (Resource Owner Password)",
                secret: null,
                grantTypes: new List<string>
                {
                    OpenIddictConstants.GrantTypes.Password,
        ...
        // Elsa Studio ROPC Client
        var elsaStudioClientId = configurationSection["ElsaStudio:ClientId"];
        if (!elsaStudioClientId.IsNullOrWhiteSpace())
        {
            await CreateApplicationAsync(
                applicationType: OpenIddictConstants.ApplicationTypes.Web,
                name: elsaStudioClientId!,
                type: OpenIddictConstants.ClientTypes.Public,
                consentType: OpenIddictConstants.ConsentTypes.Implicit,
                displayName: "Elsa Studio (Resource Owner Password)",
                secret: null,
                grantTypes: new List<string>
                {
                    OpenIddictConstants.GrantTypes.Password,
